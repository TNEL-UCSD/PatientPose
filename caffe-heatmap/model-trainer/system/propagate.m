...
%PROPAGATE propagate poses throughout an input video
...
filename = setupwaiting(filename,folder,jobid,1,'initial_detector');
...
for itr = 1:maxitr
    ...
    %use optical flow to propagate joints temporally
